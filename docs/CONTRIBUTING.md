...
# `nf-core/phaseimpute`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving nf-core/phaseimpute.

This page describes the recommended nf-core way to contribute to both nf-core/phaseimpute and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of nf-core/phaseimpute.

> [!NOTE]
> If you need help using or modifying nf-core/phaseimpute, ask on the nf-core Slack [#phaseimpute](https://nfcore.slack.com/channels/phaseimpute) channel ([join our Slack here](https://nf-co.re/join/slack)).
...
- [ ] Check whether a GitHub [issue](https://github.com/nf-core/phaseimpute/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [nf-core/phaseimpute repository](https://github.com/nf-core/phaseimpute) to your GitHub account.
...
For further information and help, see the [nf-core/phaseimpute documentation](https://nf-co.re/phaseimpute/usage) or ask on the nf-core [#phaseimpute](https://nfcore.slack.com/channels/phaseimpute) Slack channel ([join our Slack here](https://nf-co.re/join/slack)).

### GitHub Codespaces

You can contribute to nf-core/phaseimpute without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/nf-core/phaseimpute/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the nf-core/phaseimpute code and processing logic more understandable for new contributors and to ensure quality.
