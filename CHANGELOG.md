...
- [#93](https://github.com/nf-core/phaseimpute/pull/93) - Add support for CRAM file. Check contigs name at workflow level for BAM and VCF. Samples remove with multiallelics records. Samtools merge in BAM_REGION sbwf. Fix glimpse2_phase output file names. Fix fai combination to fasta.
