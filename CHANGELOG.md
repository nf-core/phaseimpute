...
- [#75](https://github.com/nf-core/phaseimpute/pull/75) - Set frequency computation with VCFFIXUP process as optional. Use Glimpse_chunk on panel vcf to compute the chunk and not makewindows on fasta.
